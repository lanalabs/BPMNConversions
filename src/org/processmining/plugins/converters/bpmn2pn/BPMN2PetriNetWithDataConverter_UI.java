...
public class BPMN2PetriNetWithDataConverter_UI extends ProMPropertiesPanel {

	private static final long serialVersionUID = 1L;
	
	private javax.swing.JCheckBox linkSubProcessToActivityBox;
	
	private static final String DIALOG_NAME = "Options for translation to Petri net with Data";
	
	public BPMN2PetriNetWithDataConverter_UI(BPMN2PetriNetWithDataConverter_Configuration config) {
	 ...
	 */
	public InteractionResult setParameters(UIPluginContext context, BPMN2PetriNetWithDataConverter_Configuration config) {
	 ...
	 */
	private void getChosenParameters(BPMN2PetriNetWithDataConverter_Configuration config) {
	...
	protected InteractionResult getUserChoice(UIPluginContext context) {
		return context.showConfiguration("Translate BPMN to Data Petri net", this);
	}
	...
	protected Object[] userCancel(PluginContext context) {
		return BPMN2PetriNetConverter_Plugin.cancel(context, "The user has cancelled BPMN2PetriNetConverterWithData.");
	}
